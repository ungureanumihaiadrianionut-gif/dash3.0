...
/**
 * Simplified Bluetooth connector for SPP ELM327 devices.
 * In real apps, ensure BLUETOOTH_CONNECT/SCAN permissions are requested and handled.
 */
class BluetoothConnector(private val address: String) {
    ...
    suspend fun queryPID(pid: String): String? {
        ...
        var read: Int
        // naive read loop - production code should be more robust
        while (true) {
